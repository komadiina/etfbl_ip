...
public class RentalScooterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        request.getSession().setAttribute("electricScooters", tdRepository.findScooters());
        request.getRequestDispatcher("/WEB-INF/views/rent-scooter.jsp").forward(request, response);
    }
